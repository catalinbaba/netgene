...
/**
 * New RPROP without weight back tracking.
 * 
 * @author CBaba
 */
public class iRPROPp extends RPROP implements Serializable
{
    private static final long serialVersionUID = 1L;
    
    /**
    * Create a new iRPROPp optimizer
    */
    public iRPROPp() {}
    ...
    public double calculateWeightChanges(Connection connection)
    {
        ...
        else if(signum <0)
        {
            ...
            if(weightGradient > prevWeightGradient)
            {
